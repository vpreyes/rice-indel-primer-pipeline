...
A fully automated pipeline for designing PCR primers targeting InDel (insertion/deletion) markers in QTL regions of rice (*Oryza sativa*). Primers are validated for specificity via BLAST, checked for correct flanking of the InDel, and formatted using a standardized naming convention (IDS format).
